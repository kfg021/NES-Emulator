...
uint32_t Mapper2::mapToPRGView(uint16_t cpuAddress) const {
...
uint32_t Mapper2::mapToPRGRead(uint16_t cpuAddress) {
    return mapToPRGView(cpuAddress);
}
uint32_t Mapper2::mapToPRGWrite(uint16_t cpuAddress, uint8_t value) {
...
uint32_t Mapper2::mapToCHRView(uint16_t ppuAddress) const {
...
uint32_t Mapper2::mapToCHRRead(uint16_t ppuAddress) {
    return mapToCHRView(ppuAddress);
}
uint32_t Mapper2::mapToCHRWrite(uint16_t ppuAddress, uint8_t /*value*/) {
